...
class AdminVerifyShop extends StatefulWidget {
  @override
  _AdminVerifyShopState createState() => _AdminVerifyShopState();
}

class _AdminVerifyShopState extends State<AdminVerifyShop> {
